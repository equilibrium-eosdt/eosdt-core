    ...
    return {
        ...
        onInit: function (w) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                _a = w.ctx, events = _a.events, refId = _a.refId;
                w.update({
                    form: form_1.default({
                        id: "create-position",
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        if (!(Number.isFinite(deposit) &&
                                            ...
                                            generate > 0)) return [3, 5];
                                        if (!!refId) return [3, 2];
                                        return [4, contract.create(account.name, deposit, generate)];
                                    case 1:
                                        _b.sent();
                                        return [3, 4];
                                    case 2: return [4, contract.createWithReferral(account.name, deposit, generate, refId)];
                                    case 3:
                                        _b.sent();
                                        _b.label = 4;
                                    case 4:
                                        ...
                                        return [3, 6];
                                    case 5: throw new Error(globals_1.t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Wrong data"], ["Wrong data"]))));
                                    case 6: return [3, 8];
                                    case 7: throw new Error(globals_1.t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["No data"], ["No data"]))));
                                    case 8: return [2];
                                }
                            });
                        }); },
