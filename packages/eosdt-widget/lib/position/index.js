...
var ManagePosition = {
    ...
    onInit: function (w) { return __awaiter(_this, void 0, void 0, function () {
        function updateData() {
            return __awaiter(this, void 0, void 0, function () {
                var balance, paramsState, positionsContract, stability_rate, eos_staked, _a, outstanding, collateral, eosBalance, k, eos, eosdt, positions_2, params_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            balance = w.state.balance;
                            paramsState = w.state.params;
                            return [4, contract.getAllUserPositions(name)];
                        case 1:
                            positionsContract = _b.sent();
                            stability_rate = paramsState.stability_rate, eos_staked = paramsState.eos_staked;
                            if (!positionsContract[0]) {
                                return [2];
                            }
                            _a = positionsContract[0], outstanding = _a.outstanding, collateral = _a.collateral;
                            eosBalance = balance ? balance[0] : "0";
                            k = (parseFloat(eosBalance) + parseFloat(eos_staked)) /
                                parseFloat(params.total_collateral);
                            eos = parseFloat(collateral) * k;
                            eosdt = parseFloat(outstanding) * parseFloat(stability_rate);
                            if (!(w.state.eos !== eos || w.state.eosdt !== eosdt)) return [3, 3];
                            positions_2 = positionsContract;
                            return [4, contract.getParameters()];
                        case 2:
                            params_1 = _b.sent();
                            w.update({ positions: positions_2, params: params_1 });
                            _b.label = 3;
                        case 3: return [2];
                    }
                });
        ...
        var _a, client, events, baseUrl, rawAccount, account, contract, name, params, positions, rates, settings, balance, userBalanceArray, userBalanceEos, EosRate, NutRate, nutBalance, userBalanceNut, eosdtBalance, userBalanceEosdt, getNUTAmount, createPosition, parameters, userBalances, currencyRates, tabs;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = w.ctx, client = _a.client, events = _a.events, baseUrl = _a.baseUrl;
                    rawAccount = client.account;
                    if (!rawAccount) {
                ...
                case 8:
                    ...
                    getNUTAmount = function (value) {
                        ...
                        var outstandingDelta = outstanding / Number(params.stability_rate);
    ...
    onUpdate: function (w) { return __awaiter(_this, void 0, void 0, function () {
        var state, params, rates, settings, balance, positions, rate, stability_rate, eos_staked, _a, outstanding, collateral, eosBalance, k, eos, eosdt, usd, minLtv, ltv, minRate, maxEos, maxEosdt, client, rawAccount, account;
        return __generator(this, function (_b) {
            state = w.state;
            ...
            if (w.state.account && account.name !== w.state.account.name) {
                w.update({ account: account });
            }
            return [2];
        });
    }); },
    render: function (state, r) {
        var baseUrl = state.baseUrl, params = state.params, account = state.account, positions = state.positions, contract = state.contract, rates = state.rates, balance = state.balance, eos = state.eos, eosdt = state.eosdt, createPosition = state.createPosition, tabs = state.tabs;
        if (!account || !account.name) {
            return globals_1.t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      <div class=\"equil-position-manage__header\">\n        <a\n          class=\"equil-position-manage__logo\"\n          href=\"https://eosdt.com/\"\n          target=\"_blank\"\n        >\n          <img src=\"", "public/img/logo.svg\" />\n        </a>\n        <a\n          class=\"equil-position-manage__telegram\"\n          href=\"https://t.me/equilibrium_eosdt_official\"\n          target=\"_blank\"\n        >\n          Join us in Telegram\n        </a>\n      </div>\n      <div class=\"equil-position-manage__wrapper equil-position-manage__wrapper--loading\">\n        <h2 class=\"equil-position-manage__parametersTitle\">Waiting for account...</h2>\n      </div>\n      "], ["\n      <div class=\"equil-position-manage__header\">\n        <a\n          class=\"equil-position-manage__logo\"\n          href=\"https://eosdt.com/\"\n          target=\"_blank\"\n        >\n          <img src=\"", "public/img/logo.svg\" />\n        </a>\n        <a\n          class=\"equil-position-manage__telegram\"\n          href=\"https://t.me/equilibrium_eosdt_official\"\n          target=\"_blank\"\n        >\n          Join us in Telegram\n        </a>\n      </div>\n      <div class=\"equil-position-manage__wrapper equil-position-manage__wrapper--loading\">\n        <h2 class=\"equil-position-manage__parametersTitle\">Waiting for account...</h2>\n      </div>\n      "])), baseUrl);
        }
        if (!contract) {
            return globals_1.t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<h2 class=\"equil-position-manage__parametersTitle\">Waiting for contract...</h2>"], ["<h2 class=\"equil-position-manage__parametersTitle\">Waiting for contract...</h2>"])));
        }
        if (!params) {
            return globals_1.t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["<h2 class=\"equil-position-manage__parametersTitle\">Waiting for params...</h2>"], ["<h2 class=\"equil-position-manage__parametersTitle\">Waiting for params...</h2>"])));
        }
        if (!rates) {
            return globals_1.t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["<h2 class=\"equil-position-manage__parametersTitle\">Waiting for rates...</h2>"], ["<h2 class=\"equil-position-manage__parametersTitle\">Waiting for rates...</h2>"])));
        }
        ...
        if (!Array.isArray(positions) || positions.length < 1) {
            if (createPosition) {
                return r(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n          <div class=\"equil-position-manage__header\">\n            <a\n              class=\"equil-position-manage__logo\"\n              href=\"https://eosdt.com/\"\n              target=\"_blank\"\n            >\n              <img src=\"", "public/img/logo.svg\" />\n            </a>\n            <a\n              class=\"equil-position-manage__telegram\"\n              href=\"https://t.me/equilibrium_eosdt_official\"\n              target=\"_blank\"\n            >Join us in Telegram</a>\n          </div>\n          <div class=\"equil-position-manage__wrapper\">\n            <div class=\"equil-position-actions\">\n              <h2 class=\"equil-position-manage__title\">\n                ", "\n              </h2>\n              ", "\n            </div>\n            <div class=\"equil-position-parameters equil-position-parameters--empty\">\n              <h2 class=\"equil-position-manage__parametersTitle\">", "</h2>\n                <span class=\"equil-position-parameters__title\">", "</span>\n                <div class=\"equil-position-userParams\" style=\"display:none\">\n                  <div class=\"equil-position-userParams__param\">\n                    <span class=\"equil-position-userParams__title\">", "</span>\n                    <span class=\"equil-position-userParams__number\">", " EOS</span>\n                  </div>\n                  <div class=\"equil-position-userParams__param\">\n                    <span class=\"equil-position-userParams__title\">", "</span>\n                    <span class=\"equil-position-userParams__number\">14 EOSDT</span>\n                  </div>\n                </div>\n            </div>\n          </div>\n          <div class=\"equil-position-manage__balanceAndPrice\">\n            <div class=\"equil-position-manage__wrapper\">\n              <h2 class=\"equil-position-manage__title\">\n                ", "\n              </h2>\n              ", "\n            </div>\n            <div class=\"equil-position-manage__wrapper\">\n              <h2 class=\"equil-position-manage__title\">\n                ", "\n              </h2>\n              ", "\n            </div>\n          </div>\n      "], ["\n          <div class=\"equil-position-manage__header\">\n            <a\n              class=\"equil-position-manage__logo\"\n              href=\"https://eosdt.com/\"\n              target=\"_blank\"\n            >\n              <img src=\"", "public/img/logo.svg\" />\n            </a>\n            <a\n              class=\"equil-position-manage__telegram\"\n              href=\"https://t.me/equilibrium_eosdt_official\"\n              target=\"_blank\"\n            >Join us in Telegram</a>\n          </div>\n          <div class=\"equil-position-manage__wrapper\">\n            <div class=\"equil-position-actions\">\n              <h2 class=\"equil-position-manage__title\">\n                ", "\n              </h2>\n              ", "\n            </div>\n            <div class=\"equil-position-parameters equil-position-parameters--empty\">\n              <h2 class=\"equil-position-manage__parametersTitle\">", "</h2>\n                <span class=\"equil-position-parameters__title\">", "</span>\n                <div class=\"equil-position-userParams\" style=\"display:none\">\n                  <div class=\"equil-position-userParams__param\">\n                    <span class=\"equil-position-userParams__title\">", "</span>\n                    <span class=\"equil-position-userParams__number\">",
                    " EOS</span>\n                  </div>\n                  <div class=\"equil-position-userParams__param\">\n                    <span class=\"equil-position-userParams__title\">", "</span>\n                    <span class=\"equil-position-userParams__number\">14 EOSDT</span>\n                  </div>\n                </div>\n            </div>\n          </div>\n          <div class=\"equil-position-manage__balanceAndPrice\">\n            <div class=\"equil-position-manage__wrapper\">\n              <h2 class=\"equil-position-manage__title\">\n                ", "\n              </h2>\n              ", "\n            </div>\n            <div class=\"equil-position-manage__wrapper\">\n              <h2 class=\"equil-position-manage__title\">\n                ", "\n              </h2>\n              ", "\n            </div>\n          </div>\n      "])), baseUrl, globals_1.t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Create position"], ["Create position"]))), createPosition, globals_1.t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["You don't have any positions yet"], ["You don't have any positions yet"]))), globals_1.t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Deposit collateral and generate <br/>EOSDT to get started"], ["Deposit collateral and generate <br/>EOSDT to get started"]))), globals_1.t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Available to deposit"], ["Available to deposit"]))), state.userBalanceEos ||
                    "0.00", globals_1.t(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Max available to generate"], ["Max available to generate"]))), globals_1.t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Balance"], ["Balance"]))), state.userBalances, globals_1.t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Price"], ["Price"]))), state.currencyRates);
            }
            else {
                return globals_1.t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Loading..."], ["Loading..."])));
            }
        }
        var rate = rates.find(function (rate) { return rate.rate.indexOf("USD") >= 0; });
        if (!rate) {
            throw new Error(globals_1.t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["No USD rate"], ["No USD rate"]))));
        }
        if (tabs) {
            return r(templateObject_26 || (templateObject_26 = __makeTemplateObject(["\n      <div class=\"equil-position-manage__header\">\n        <a\n          class=\"equil-position-manage__logo\"\n          href=\"https://eosdt.com/\"\n          target=\"_blank\"\n        >\n          <img src=\"", "public/img/logo.svg\" />\n        </a>\n        <a\n          class=\"equil-position-manage__telegram\"\n          href=\"https://t.me/equilibrium_eosdt_official\"\n          target=\"_blank\"\n        >Join us in Telegram</a>\n      </div>\n      <div class=\"equil-position-manage__wrapper\">\n        <div class=\"equil-position-actions\">\n          <h2 class=\"equil-position-manage__title\">\n            ", "\n          </h2>\n          <div class=\"equil-position-actions__labels\">\n            <div class=\"equil-position-actions__label\">\n              <span>", "</span>\n              <span class=\"equil-position-actions__value\">", "</span>\n            </div>\n            <div class=\"equil-position-actions__label\">\n              <span>", "</span>\n              <span class=\"equil-position-actions__value\">", "</span>\n            </div>\n          </div>\n          ", "\n        </div>\n        ", "\n      </div>\n      <div class=\"equil-position-manage__balanceAndPrice\">\n        <div class=\"equil-position-manage__wrapper\">\n          <h2 class=\"equil-position-manage__title\">\n            ", "\n          </h2>\n          ", "\n        </div>\n        <div class=\"equil-position-manage__wrapper\">\n          <h2 class=\"equil-position-manage__title\">\n            ", "\n          </h2>\n          ", "\n        </div>\n"], ["\n      <div class=\"equil-position-manage__header\">\n        <a\n          class=\"equil-position-manage__logo\"\n          href=\"https://eosdt.com/\"\n          target=\"_blank\"\n        >\n          <img src=\"", "public/img/logo.svg\" />\n        </a>\n        <a\n          class=\"equil-position-manage__telegram\"\n          href=\"https://t.me/equilibrium_eosdt_official\"\n          target=\"_blank\"\n        >Join us in Telegram</a>\n      </div>\n      <div class=\"equil-position-manage__wrapper\">\n        <div class=\"equil-position-actions\">\n          <h2 class=\"equil-position-manage__title\">\n            ",
                "\n          </h2>\n          <div class=\"equil-position-actions__labels\">\n            <div class=\"equil-position-actions__label\">\n              <span>", "</span>\n              <span class=\"equil-position-actions__value\">",
                "</span>\n            </div>\n            <div class=\"equil-position-actions__label\">\n              <span>", "</span>\n              <span class=\"equil-position-actions__value\">",
                "</span>\n            </div>\n          </div>\n          ", "\n        </div>\n        ", "\n      </div>\n      <div class=\"equil-position-manage__balanceAndPrice\">\n        <div class=\"equil-position-manage__wrapper\">\n          <h2 class=\"equil-position-manage__title\">\n            ", "\n          </h2>\n          ", "\n        </div>\n        <div class=\"equil-position-manage__wrapper\">\n          <h2 class=\"equil-position-manage__title\">\n            ", "\n          </h2>\n          ", "\n        </div>\n"])), baseUrl, globals_1.t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Manage position of <i class=\"equil-position-manage__username\">", "</i>"], ["Manage position of <i class=\"equil-position-manage__username\">",
                "</i>"])), account.name), globals_1.t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["EOS collateral"], ["EOS collateral"]))), eos.toFixed(4), globals_1.t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["EOSDT generated"], ["EOSDT generated"]))), eosdt.toFixed(2), tabs, state.parameters, globals_1.t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["Balance"], ["Balance"]))), state.userBalances, globals_1.t(templateObject_25 || (templateObject_25 = __makeTemplateObject(["Price"], ["Price"]))), state.currencyRates);
        }
        else {
            return globals_1.t(templateObject_27 || (templateObject_27 = __makeTemplateObject(["Loading..."], ["Loading..."])));
        }
    },
};
